    ...
    return (
            ...
            <form class="flex flex-col w-full items-center">
              <div className="flex flex-col justify-between w-[90%] border border-primary rounded-lg bg-[#FCFCFC]">
                ...
                <div className="p-6">
                  <h3 className="text-black font-bold text-md">Os valores de tendência e paralelismo, foram determinados por comparação, sendo utilizado um padrão
                    escalonado conjugado com blocos individuais, rastreados ao padrão nacional.</h3>
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-black font-bold text-md">Paralelismo</h3>
                </div>
                ...
                <h3 className="text-black font-bold text-md">- Os ajustes efetuados no instrumento não fazem parte do escopo da Acreditação.</h3>
                <h3 className="text-black font-bold text-md">- A incerteza expandida de medição relatada é declarada como a incerteza padrão de medição 
